...
- Confirm optional photos and video upload directly to Supabase Storage through signed upload URLs.
- Confirm uploaded file rows are created in `lead_files` and internal email links can be opened.
