...
export function MobileStickyCTA() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-white/60 bg-white/88 px-5 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-16px_50px_rgba(27,25,23,0.14)] backdrop-blur-xl sm:hidden">
